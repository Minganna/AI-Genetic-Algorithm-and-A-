...
static int closed_nodes_map[21][21]; // map of closed (tried-out) nodes
static int open_nodes_map[21][21]; // map of open (not-yet-tried) nodes
static int dir_map[21][21]; // map of directions
...
void AStar(Mazed maze)
{
	...
	glm::vec2 Astarmap = maze.getMapsize();
	n = Astarmap.x;
	m = Astarmap.y;
